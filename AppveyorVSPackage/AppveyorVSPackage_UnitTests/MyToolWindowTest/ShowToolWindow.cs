...
using memamjome.AppveyorVSPackage;

namespace AppveyorVSPackage_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new AppveyorVSPackagePackage() as IVsPackage;
            ...
            MethodInfo method = typeof(AppveyorVSPackagePackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
